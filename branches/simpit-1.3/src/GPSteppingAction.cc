...
void GPSteppingAction::Init()
{
    ...
    dTargetL = detector->GetTargetLength();
    dTargetX = detector->GetTargetX();
    dTargetY = detector->GetTargetY();
    dCaptureL = detector->GetCaptureLength();
    dCaptureR = detector->GetCaptureRadius();
